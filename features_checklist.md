...
| **[x]** | **Cross-Brand Shade Converter** | Pencarian padanan kosmetik lintas merek komersial dengan kalkulasi jarak warna CIELAB Delta E76 luring (Free tier dibatasi 1 produk teratas, shade alternatif dikunci). | `lib/features/catalog/presentation/pages/shade_converter_page.dart` |
...
| **[x]** | **Paywall & Offline Access** | Validasi status langganan premium melalui database Isar, pembatasan 2 shade match + kunci filter Brightening/Sunkissed, lock Couple Mode, kuota 3 scan OCR harian, dan batas 3 item Virtual Pouch untuk Free Tier. | `lib/features/premium_subscription/data/models/app_settings.dart` |
...
| **[x]** | **Panduan Kontur Wajah Interaktif (Live AR Guide Overlay)** | Garis pandu shading kontur wajah interaktif secara real-time pada kamera AR berdasarkan deteksi tipe bentuk wajah (Round/Square/Oval). | `lib/features/premium_subscription/` |
