...
| **[ ]** | **Kamus Kandungan Skincare Offline (dengan OCR Scanner Kamera)** | Kamus luring kandungan skincare aktif (misal: BHA, Retinol) dengan pemindai teks OCR kamera untuk mendeteksi kecocokan tipe kulit secara offline. | `lib/features/scanner/` |
